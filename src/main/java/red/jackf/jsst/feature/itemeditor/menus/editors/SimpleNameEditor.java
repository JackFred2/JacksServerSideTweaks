...
public class SimpleNameEditor extends GuiEditor {
    ...
    protected void redraw() {
        ...
        this.setSlot(2, GuiElementBuilder.from(new ItemStack(Items.WRITABLE_BOOK))
                .setName(Translations.change().withStyle(Styles.INPUT_HINT))
                .addLoreLine(Hints.leftClick())
                .setCallback(Inputs.leftClick(this::changeName)));
    ...
    private void changeName() {
        Sounds.click(player);
        Menus.string(player,
                     Component.translatable("jsst.itemEditor.simpleName.changeName"),
